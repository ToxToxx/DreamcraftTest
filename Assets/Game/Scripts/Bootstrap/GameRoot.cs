...
namespace Game.Gameplay.Bootstrap
{
    ...
    public sealed class GameRoot : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            Transform groundInst = null;
            if (_groundPrefab) groundInst = Instantiate(_groundPrefab);
            ...
            _di.BindInstance(player);

            if (groundInst) (_di as Container)!.InjectGameObject(groundInst.gameObject);
            (_di as Container)!.InjectGameObject(_camera.gameObject);
